...
class TransferSaldoController extends Controller
{
    ...
    public function store(Request $request)
    {
        // Validasi Input
        $request->validate([
            'username' => 'required', // Memastikan 'username' tidak boleh kosong
            'saldo' => 'required | numeric', // Memastikan 'saldo' tidak boleh kosong dan harus berupa angka
        ]);
        ...
        return redirect('/transfer-saldo')->with('success', 'Saldo berhasil ditransfer.');
    }
