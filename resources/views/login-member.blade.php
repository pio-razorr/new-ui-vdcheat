                        ...
                        <div class="card m-0" data-aos="zoom-in">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    {{-- Toggle dark mode --}}
                                    <div class="theme-toggle d-flex gap-2  align-items-center mt-3 mt-sm-0">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <img src="{{ asset('assets-pio/img/alvin-cheat.webp') }}" alt=""
                                            class="img-fluid w-25">
                                    </div>

                                    <h4 class="card-title text-center">Member Login</h4>
                                    <p class="card-text text-center">
                                        Masukkan member id dengan benar
                                    </p>
                                    ...
                                    <form class="form" action="/login-member" method="POST">
                                        @csrf
                                        <div class="form-body">
                                        ...
                                        <div>
                                            <p class="m-0 mt-3 text-center">Anda seller ? <a href="/login">silahkan
                                                    login disini</a></p>
                                        </div>
                                    </form>
                                </div>
