                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ !$dataMember['perpanjang'] ? 'active' : '' }}" id="home-tab"
                                data-bs-toggle="tab" href="#home" role="tab" aria-controls="home"
                                aria-selected="{{ !$dataMember['perpanjang'] }}">Transaksi baru</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ $dataMember['perpanjang'] ? 'active' : '' }}" id="profile-tab"
                                data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                                aria-selected="{{ $dataMember['perpanjang'] }}" tabindex="-1">Perpanjang</a>
                        </li>
                    </ul>
                    <div class="tab-content mt-4" id="myTabContent">

                        {{-- TRANSAKSI BARU --}}
                        <div class="tab-pane fade {{ !$dataMember['perpanjang'] ? 'show active' : '' }}" id="home"
                        ...
                        {{-- PERPANJANG --}}
                        <div class="tab-pane fade {{ $dataMember['perpanjang'] ? 'show active' : '' }}" id="profile"
                            ...
                            <form class="form" action="/transaksi" method="get">
                                <div class="form-body">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="Masukkan member id"
                                            name="member_id" id="member-id" value="{{ $dataMember['input_member'] }}"
                                            required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="info-member" placeholder="-"
                                    value="{{ $dataMember['pesan'] }}" disabled>
                            </div>
                            ...
                            @if (session('success'))
                                <form action="/transaksi/{{ $dataMember['member_id'] }}" method="post">
                                    ...
                                    <div class="form-actions mt-4">
                                        <button type="submit" class="btn btn-primary me-1">Perpanjang</button>
                                    </div>
                                </form>
                            @endif
                        </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="alert alert-light-success color-success"><i
                                    class="bi bi-check-circle me-2"></i>VVIP MODS - Pembelian Cheat.
                            </div>
                            <div class="list-group">
                                ...
                                <ul class="list-group">
                                    ...
                                    <p>Login member <a
                                            href="#" target="_blank">http://www.instagram.com/pio_razorr</a>
                                    </p>
            ...
            @if (Session::get('success-perpanjang'))
                ...
                <h4 class="card-title"><i class="bi bi-check2-all me-2"></i>Alvin Cheat - Pembelian Cheat</h4>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="alert alert-light-success color-success"><i
                                    class="bi bi-check-circle me-2"></i>VVIP MODS - Perpanjang Cheat.
                            </div>
                            <div class="list-group">
